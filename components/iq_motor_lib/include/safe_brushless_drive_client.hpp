...
/*
  Name: safe_brushless_drive_client.hpp
  Last update: 3/7/2019 by Raphael Van Hoffelen
  Author: Matthew Piccoli
  Contributors: Raphael Van Hoffelen
*/

#ifndef SAFE_BRUSHLESS_DRIVE_CLIENT_HPP_
#define SAFE_BRUSHLESS_DRIVE_CLIENT_HPP_

#include "client_communication.hpp"

const uint8_t kTypeBrushlessDrive = 50;

class SafeBrushlessDriveClient: public ClientAbstract{
  public:
    SafeBrushlessDriveClient(uint8_t obj_idn):
...
#endif /* SAFE_BRUSHLESS_DRIVE_CLIENT_HPP_ */
